...
jobs:
  test:
    ...
    - name: Test in FreeBSD
      id: test
      uses: bedwardly-down/freebsd-vm@rsync7
      with:
...
The latest major version is: `rsync7`, which is the most recommended to use. (You can also use the latest full version: `rsync7`)  
