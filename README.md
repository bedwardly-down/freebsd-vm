...
jobs:
  test:
    ...
    - name: Test in FreeBSD
      id: test
      uses: bedwardly-down/freebsd-vm@rsync2
      with:
...
The latest major version is: `rsync2`, which is the most recommended to use. (You can also use the latest full version: `rsync2`)  
