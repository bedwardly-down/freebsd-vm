...
jobs:
  test:
    ...
    - name: Test in FreeBSD
      id: test
      uses: bedwardly-down/freebsd-vm@custom8
      with:
...
The latest major version is: `custom8`, which is the most recommended to use. (You can also use the latest full version: `custom8`)  
