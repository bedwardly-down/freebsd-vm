...
jobs:
  test:
    ...
    - name: Test in FreeBSD
      id: test
      uses: bedwardly-down/freebsd-vm@rsync1
      with:
...
The latest major version is: `rsync1`, which is the most recommended to use. (You can also use the latest full version: `rsync1`)  
